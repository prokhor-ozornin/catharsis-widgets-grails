...
class RuTubeTagLibTests
{
  void test_video_tag()
  {
    ...
    assert applyTemplate('<rutube:video id="id" width="width" height="height"/>') == '<iframe frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" scrolling="no" width="width" height="height" src="http://rutube.ru/embed/id"></iframe>'
  }
}
